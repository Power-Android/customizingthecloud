...
import com.power.customizingthecloud.fragment.mine.AllBreedIncomeFragment;
import com.power.customizingthecloud.fragment.mine.AllRenyangFragment;
import com.power.customizingthecloud.fragment.mine.IngBreedIncomeFragment;
import com.power.customizingthecloud.fragment.mine.IngRenyangFragment;
import com.power.customizingthecloud.fragment.mine.OverBreedIncomeFragment;
...
public class BreedIncomeDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_breed_income_detail);
        ...
        if (fragmentList.size() == 0) {
            fragmentList.add(new AllBreedIncomeFragment());
            fragmentList.add(new IngBreedIncomeFragment());
            fragmentList.add(new OverBreedIncomeFragment());
        }
