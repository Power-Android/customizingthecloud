...
public class TuiHuoAndMoneyActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tui_huo_and_money);
    ...
    private void initTkyyDialog() {
        ...
        OkGo.<ReturnMoneyTypeBean>get(Urls.BASEURL + "api/v2/user/order-return")
                ...
                .headers(headers)
                .params(params)
                .execute(new DialogCallback<ReturnMoneyTypeBean>(TuiHuoAndMoneyActivity.this, ReturnMoneyTypeBean.class) {
                             @Override
    ...
    private void commitTuikuan() {
        ...
        OkGo.<BaseBean>post(Urls.BASEURL + "api/v2/user/order-return-post")
                ...
                .headers(headers)
                .params(params)
                .execute(new DialogCallback<BaseBean>(TuiHuoAndMoneyActivity.this, BaseBean.class) {
                             @Override
                             public void onSuccess(Response<BaseBean> response) {
                                 int code = response.code();
                                 BaseBean body = response.body();
                                 Toast.makeText(TuiHuoAndMoneyActivity.this, body.getMessage(), Toast.LENGTH_SHORT).show();
                                 finish();
                             }
    ...
    @OnClick({R.id.title_back_iv, R.id.tkyy_ll, R.id.commit_tv})
