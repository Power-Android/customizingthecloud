...
public class IngBreedIncomeFragment extends BaseFragment {
...
//        MyBreedIncomeAdapter breedIncomeAdapter=new MyBreedIncomeAdapter(R.layout.item_breed_income,list,mContext,2);
