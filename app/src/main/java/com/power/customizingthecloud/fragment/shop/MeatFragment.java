...
//                                            startActivity(intent);
//                                        }
                                        switch (good_sild.get(position).getTarge_type()) {
                                            case 1:
                                                Intent intent = new Intent(mContext, GoodDetailActivity.class);
                                                intent.putExtra("id", good_sild.get(position).getTarge_url());
                                                startActivity(intent);
                                            ...
                                            case 2:
                                                ...
                                                intent2.putExtra("id", good_sild.get(position).getTarge_url());
                                                startActivity(intent2);
                                                break;
                                            case 3:
                                                Intent intent3 = new Intent(mContext, JianKongActivity.class);
                                                try {
                                                    int i = Integer.parseInt(good_sild.get(position).getTarge_url());
