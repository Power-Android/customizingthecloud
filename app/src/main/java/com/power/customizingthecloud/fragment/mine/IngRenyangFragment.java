...
public class IngRenyangFragment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener {
        ...
        OkGo.<MyRenyangBean>get(Urls.BASEURL + "api/v2/user/donkey")
                ...
                .execute(new DialogCallback<MyRenyangBean>(mActivity,MyRenyangBean.class) {
                    ...
                    public void onSuccess(Response<MyRenyangBean> response) {
                        ...
                        if (body.getCode() == 1){
                            list = body.getData();
                            renYangAdapter = new MyRenYangAdapter(R.layout.item_my_renyang,list,mContext,2);
                            mRecyclerRenyang.setAdapter(renYangAdapter);
                            renYangAdapter.setOnItemClickListener(IngRenyangFragment.this);
                        }
                    }
                });
    }
